export const translations = {
  en: {
    nav: { home: 'Home', about: 'About', research: 'Research', blog: 'Blog', contact: 'Contact' },
    hero: {
      badge: 'Open to PhD & Research Collaboration',
      title: 'AI Researcher · Electrical Engineer · Control Systems Specialist',
      subtitle: 'Computer Vision & Object Detection · Reinforcement Learning · Intelligent Control · Edge AI',
      primary: 'Explore Research', secondary: 'Get In Touch',
      award: 'Top Technologist · Hamedan Province ×2', rank: 'Ranked 1st · M.S. Cohort 2018'
    },
    about: {
    ...
    footer: 'AI · Control Systems · Computer Vision · Intelligent Engineering',
    notFound: { title: 'Page not found', text: 'The page you requested does not exist.', action: 'Return home' }
  },
  fa: {
    nav: { home: 'خانه', about: 'درباره من', research: 'پژوهش‌ها', blog: 'وبلاگ', contact: 'تماس' },
    hero: {
      badge: 'آماده همکاری پژوهشی و فرصت‌های دکتری',
      title: 'پژوهشگر هوش مصنوعی · مهندس برق · متخصص سیستم‌های کنترل',
      subtitle: 'بینایی ماشین و تشخیص شیء · یادگیری تقویتی · کنترل هوشمند · هوش لبه',
      primary: 'مشاهده پژوهش‌ها', secondary: 'تماس با من',
      award: 'برگزیده فناور برتر استان همدان ×۲', rank: 'رتبه اول · ورودی کارشناسی ارشد ۱۳۹۷'
    },
    about: {
    ...
    footer: 'هوش مصنوعی · سیستم‌های کنترل · بینایی ماشین · مهندسی هوشمند',
    notFound: { title: 'صفحه پیدا نشد', text: 'صفحه‌ای که درخواست کرده‌اید وجود ندارد.', action: 'بازگشت به خانه' }
  }
}
