...
export default function Home() {
  ...
  const projects = fa ? [
    ...
    { title:'تشخیص شیء و ادراک خودرو', text:'طراحی دیتاست، تشخیص شیء با خانواده YOLO و مطالعه روش‌های ناحیه‌محور برای سناریوهای شهری و خودروهای امدادی.', icon: Radar, blog:'vehicle-detection-yolo-emergency-vehicles', image:'/images/research/vehicle-ambulance.webp' },
    { title:'مدیریت انرژی هوشمند', text:'کنترل فازی و تطبیقی غیرخطی برای هماهنگی بارهای سرمایشی با انرژی تجدیدپذیر.', icon: BrainCircuit, blog:'sustainable-energy-fuzzy-control', image:'/images/research/energy-demand.webp' }
  ] : [
    ...
    { title:'Object Detection & Vehicle Perception', text:'Dataset engineering and object detection with the YOLO family, including dedicated emergency-vehicle classes for intelligent transportation.', icon: Radar, blog:'vehicle-detection-yolo-emergency-vehicles', image:'/images/research/vehicle-ambulance.webp' },
    { title:'Intelligent Energy Management', text:'Fuzzy and adaptive nonlinear control for coordinating cooling loads with renewable energy.', icon: BrainCircuit, blog:'sustainable-energy-fuzzy-control', image:'/images/research/energy-demand.webp' }
  ]
